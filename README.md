...
Based on the [turndown]library (https://github.com/domchristie/turndown) and the client code hosted [here](http://domchristie.github.io/turndown/)

This Glitch project is [here on GitHub](https://github.com/eldrgeek/eldr-turndown-client)

## Documentation for `turndown`
